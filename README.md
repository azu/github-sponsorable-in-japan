...
| [logseq-plugin-some-menu-extender](https://github.com/YU000jp/logseq-plugin-some-menu-extender) | adds new functions to Logseq contextmenus and others, allowing for more efficient and convenient operations |
