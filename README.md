...
| [dagu](https://github.com/dagucloud/dagu) | Self-hosted workflow orchestration in one binary. YAML DAGs, cron, AI agent steps, Web UI. AI native Airflow alternative, no database. |
