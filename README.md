...
| [dagu](https://github.com/dagu-org/dagu) | A self-contained, powerful, and language-agnostic workflow engine, alternative to Airflow, Cron, etc. It aims to solve greater problems. |
